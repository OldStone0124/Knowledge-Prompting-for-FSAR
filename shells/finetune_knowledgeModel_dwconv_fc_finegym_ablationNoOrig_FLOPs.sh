...
--ft_begin_index 0 \
--result_path /media/sda1/shiyuheng/actionKnowledgeXfewshot/few-shot-video-classification/result/train_pro_knowbase_FLOPs \
...
--proposals_fea_pth /home/shiyuheng/data/data_proposal_fea/know_base.pt \
