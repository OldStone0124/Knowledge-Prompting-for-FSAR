cd few-shot-video-classification/ && CUDA_VISIBLE_DEVICES=1 python finetune_metatrain_w_knowledge.py --video_path /home/linhanxi/home_data/k400_CMNsplit/ \
...
--ft_begin_index 0 \
--result_path /media/sda1/linhanxi/exp/few-shot-vid-cls/finetune_kinetics/knowledge_model/dwconv_fc/v0.3_clsBugFix_embedOrig_dropout0.9_ablation_origBugfix_sparseSample_TSM1_32frms_sparseBugfix_PoolBugfix_PartProposaV2.1_DEBUG_selfatten_stacking \
...
--ablation_removeOrig --this_launch_script $0 --print_freq 200 --sample_mode sparse --n_epochs 100 --temporal_modeling TSM1  --with_clip_zeroshot --way_to_use_zeroshot stacking
