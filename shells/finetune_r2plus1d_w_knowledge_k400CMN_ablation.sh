...
--ft_begin_index 0 \
--result_path /media/sda1/linhanxi/exp/few-shot-vid-cls/finetune_kinetics/w_knowledge/v0.3_clsBugFix_embedOrig_dropout0.9_ablation_orig \
--CLIP_visual_fea_reg "/media/sda1/linhanxi/data/CLIP_related/kinetics_CMN/batched_to_be_processed_visual/fea_clip_ViT-B-16_unfolded_24frms/*" \
