...
--clip_model_depth 34 \
--n_threads 4 \
--result_path /media/sda1/shiyuheng/actionKnowledgeXfewshot/few-shot-video-classification/result/test_knowbase_3e-4/ \
--shot 5 \
--test_way 5 \
--query 5 \
--resume_path /media/sda1/shiyuheng/actionKnowledgeXfewshot/few-shot-video-classification/result/knowbase_3e-4/save_34.pth \
--emb_dim 491 \
--batch_size 64 \
--lr 0.01 \
--nepoch 10 \
...
--proposals_fea_pth /home/shiyuheng/data/data_proposal_fea/knowbase_3e-4.pt \
